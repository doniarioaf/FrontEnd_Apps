...
import { editArea_Permission } from '../../shared/permissionMenu';
import * as pathmenu from '../../shared/pathMenu';
import momentLocalizer from 'react-widgets-moment';
import "react-widgets/dist/css/react-widgets.css";

export default function EditArea(props) {
    reloadToHomeNotAuthorize(editArea_Permission, 'TRANSACTION');
    ...
    const executeSubmit = (values) => {
        ...
        if (flag) {
            ...
            dispatch(actions.submitArea({ url: '/' + id, payload: obj, type: 'EDIT' }, succesHandlerSubmit, errorHandler));
        }
    }
        ...
        >
            {
                formikProps => {
                    ...
                    return (
                        <form className="mb-6" onSubmit={handleSubmit} name="FormArea">
                            <ContentWrapper>
                                <ContentHeading history={history} link={pathmenu.editarea + '/' + id} label={'Edit Area'} labeldefault={'Edit Area'} />
