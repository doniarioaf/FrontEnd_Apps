...
import { addArea_Permission } from '../../shared/permissionMenu';
import * as pathmenu           from '../../shared/pathMenu';
import momentLocalizer                 from 'react-widgets-moment';
import "react-widgets/dist/css/react-widgets.css";

export default function AddArea(props) {
    reloadToHomeNotAuthorize(addArea_Permission,'TRANSACTION');
    ...
    const executeSubmit = (values) => {
        ...
        if(flag){
            ...
            dispatch(actions.submitArea({url:'',payload:obj,type:'ADD'},succesHandlerSubmit, errorHandler));
        }
    }
                ...
                formikProps => {
                    ...
                    return(
                        <form className="mb-6" onSubmit={handleSubmit}  name="FormArea">
                            <ContentWrapper>
                            <ContentHeading history={history} link={pathmenu.addarea} label={'Add Area'} labeldefault={'Add Area'} />
