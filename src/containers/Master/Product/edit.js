...
import { editProduct_Permission } from '../../shared/permissionMenu';
import * as pathmenu from '../../shared/pathMenu';
import momentLocalizer from 'react-widgets-moment';
import "react-widgets/dist/css/react-widgets.css";

export default function EditProduct(props) {
    reloadToHomeNotAuthorize(editProduct_Permission, 'TRANSACTION');
    ...
    useEffect(() => {
        setLoading(true);
        dispatch(actions.getProductData({ url: '/' + id }, successHandler, errorHandler));
    }, []);
    ...
    const executeSubmit = (values) => {
        ...
        if (flag) {
            ...
            obj.sku = values.sku;
            dispatch(actions.submitProductData({ url: '/' + id, payload: obj, type: 'EDIT' }, succesHandlerSubmit, errorHandler));
        }
    }
                ...
                formikProps => {
                    ...
                    return (
                        <form className="mb-6" onSubmit={handleSubmit} name="FormProduct">
                            <ContentWrapper>
                                <ContentHeading history={history} link={pathmenu.editProduct + '/' + id} label={'Edit Product'} labeldefault={'Edit Product'} />
