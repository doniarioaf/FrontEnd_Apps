...
import { addProduct_Permission } from '../../shared/permissionMenu';
import * as pathmenu from '../../shared/pathMenu';
import momentLocalizer from 'react-widgets-moment';
import "react-widgets/dist/css/react-widgets.css";

export default function AddProduct(props) {
    reloadToHomeNotAuthorize(addProduct_Permission, 'TRANSACTION');
    ...
    const executeSubmit = (values) => {
        ...
        if (flag) {
            ...
            obj.sku = values.sku;
            dispatch(actions.submitProductData({ url: '', payload: obj, type: 'ADD' }, succesHandlerSubmit, errorHandler));
        }
    }
                ...
                formikProps => {
                    ...
                    return (
                        <form className="mb-6" onSubmit={handleSubmit} name="FormProduct">
                            <ContentWrapper>
                                <ContentHeading history={history} link={pathmenu.addProduct} label={'Add Product'} labeldefault={'Add Product'} />
