            ...
            <CardBody>
                {
                    ...
                    (
                        <section>
                            ...
                            <span className="col-md-5">{i18n.t('Price Date')}</span>
            ...
            <div className="mt-2 col-lg-4 ft-detail mb-3" >
                {
                    ...
                    (
                        ...
                        <div className="row justify-content-center" style={{width:"125%"}}>
                            <table id="tablegrid" >
                            <tbody>
                            <tr>
                                <th  style={{width:'60%',textAlign:'center',backgroundColor:colourPrimaryInHexa,fontSize:'larger'}}>{i18n.t('Category Product')}</th>
                                <th style={{width:'40%',textAlign:'center',backgroundColor:colourPrimaryInHexa,fontSize:'larger'}}>Price</th>
                            </tr>
                            {
                                value.items.map((x, i) => {
                                    return (
