...
import { editInventori_Permission } from '../../shared/permissionMenu';
import * as pathmenu           from '../../shared/pathMenu';
import momentLocalizer                 from 'react-widgets-moment';
import "react-widgets/dist/css/react-widgets.css";

export default function EditInventori(props) {
    reloadToHomeNotAuthorize(editInventori_Permission,'TRANSACTION');
    ...
    const executeSubmit = (values) => {
        ...
        if(flag){
            ...
            obj.sku = values.sku;
            dispatch(actions.submitInventoriData({url:'/'+id,payload:obj,type:'EDIT'},succesHandlerSubmit, errorHandler));
        }
    }
