...
export default function EditCategoryProduct(props) {
    reloadToHomeNotAuthorize(editCategoryProduct_Permission,'TRANSACTION');
                ...
                formikProps => {
                    ...
                    return(
                        <form className="mb-6" onSubmit={handleSubmit}  name="FormCustomer">
                            <ContentWrapper>
                            <ContentHeading history={history} link={pathmenu.editcategoryproduct+'/'+id} label={'Edit Category Product'} labeldefault={'Edit Category Product'} />
