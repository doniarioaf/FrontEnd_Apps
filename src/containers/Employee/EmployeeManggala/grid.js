...
import { addEmployeeManggala_Permission,MenuEmployeeManggala } from '../../shared/permissionMenu';
    ...
    return (
        <div style={{textAlign: 'center'}} title={i18n.t('grid.ADD')}>
            <Tooltip title={i18n.t('grid.ADD')}>
                <IconButton 
                hidden={!isGetPermissions(addEmployeeManggala_Permission,'TRANSACTION')}
                color={'primary'} onClick={() => history.push(pathmenu.addemployeeManggala)} >
                    <IconAdd/>
                </IconButton>
            </Tooltip>
        </div>
    ...
    return (
        <TableEditColumn.Cell row={row} {...restProps}>
            ...
            <Tooltip title={i18n.t('grid.VIEW')}>
                ...
                hidden={!isGetPermissions(MenuEmployeeManggala,'TRANSACTION')}
                            onClick={() => history.push(pathmenu.detailemployeeManggala +'/'+ row.id)}
                >
                    <IconView/>
                </IconButton>
            </Tooltip>
...
const EmployeeManggalaGrid = props => {
...
export default EmployeeManggalaGrid;