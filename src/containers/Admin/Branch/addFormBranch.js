...
export default function AddFormBranch(props) {
    ...
    // useEffect(() => {
    //     // setLoading(true);
    //     dispatch(actions.getBranchData('/getallbranchactive',successHandler, errorHandler));
    // }, []);
    ...
    const executeSubmit = () => {
        ...
        if(flag){
            ...
            dispatch(actions.submitAddBranch(obj,succesHandlerSubmit, errorHandler));
        }
    }
                ...
                formikProps => {
                    ...
                    return(
                        <form className="mb-6" onSubmit={handleSubmit}  name="FormAddBranch">
                            ...
                            <span>{i18n.t('label_ADD_BRANCH')}</span>
                            </div>
