...
export default function EditFormCompany(props) {
    ...
    function successHandlerDetail(data) {
        setInputName(data.data.company.nama);
        setInputDisplayName(data.data.company.displayname);
        setInputCode(data.data.company.code);
        setInputContactNumber(data.data.company.contactnumber);
        setInputAddress(data.data.company.address);
        setInputEmail(data.data.company.email);
        setCheckIsActived(data.data.company.isactive);
        let listbranch = data.data.listbranches.reduce((obj, el) => [
            ...obj,
            {
                'id': el.id,
                'name': el.nama
