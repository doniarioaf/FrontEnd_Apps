    ...
    return (
        <div style={{textAlign: 'center'}} title={i18n.t('grid.ADD')}>
            <Tooltip title={i18n.t('grid.ADD')}>
                <IconButton 
                hidden={!isGetPermissions(addUserMobile_Permission,'TRANSACTION')}
                color={'primary'} onClick={() => history.push(pathmenu.addusermobile)} >
                    <IconAdd/>
                </IconButton>
            </Tooltip>
            {/*<Button*/}
        ...
        <TableEditColumn.Cell row={row} {...restProps}>
            ...
            <Tooltip title={i18n.t('grid.VIEW')}>
                <IconButton color={'primary'} 
                            onClick={() => history.push(pathmenu.detailusermobile +'/'+ row.id)}
                >
                    <IconView/>
                </IconButton>
            </Tooltip>
...
export default InternalUserGrid;