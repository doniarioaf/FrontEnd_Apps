...
export default function AddFormProduct(props) {
    ...
    function successHandlerDetail(data) {
        if(data.data){
            ...
            setInputProductCode(data.data.productcode);
            setInputShortName(data.data.shortname);
            setInputPriceBuy(new String(data.data.pricebuy));
            setInputPriceSell(new String(data.data.pricesell));
            setInputPriceSellUOM2(new String(data.data.priceselluom2));
            setInputPriceSellUOM3(new String(data.data.priceselluom3));
            setInputPriceSellUOM4(new String(data.data.priceselluom4));
            setInputUom1(data.data.uom1);
            setInputUom2(data.data.uom2);
            setInputUom3(data.data.uom3);
            setInputUom4(data.data.uom4);
            setInputConvertion1to4(data.data.conversion1to4);
            setInputConvertion2to4(data.data.conversion2to4);
            setInputConvertion3to4(data.data.conversion3to4);
            setInputBarcode1(data.data.barcode1);
            setInputBarcode2(data.data.barcode2);
            setInputBarcode3(data.data.barcode3);
            setInputBarcode4(data.data.barcode4);
