...
import { addCallPlan_Permission } from '../../shared/permissionMenu';
    ...
    return (
        <div style={{textAlign: 'center'}} title={i18n.t('grid.ADD')}>
            <Tooltip title={i18n.t('grid.ADD')}>
                <IconButton
                hidden={!isGetPermissions(addCallPlan_Permission,'TRANSACTION')}
                 color={'primary'} onClick={() => history.push(pathmenu.menuaddproject)} >
                    <IconAdd/>
                </IconButton>
            </Tooltip>
    ...
    return (
        <TableEditColumn.Cell row={row} {...restProps}>
            ...
            <Tooltip title={i18n.t('grid.VIEW')}>
                <IconButton color={'primary'} 
                            onClick={() => history.push(pathmenu.detailproject +'/'+ row.id)}
                >
                    <IconView/>
                </IconButton>
            </Tooltip>
