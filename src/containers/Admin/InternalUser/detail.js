                ...
                <MenuList autoFocusItem={open} id="menu-list-grow" onKeyDown={handleListKeyDown}>
                    {
                        ...
                        :(<div>
                            ...
                            <MenuItem hidden={!isGetPermissions(changePasswordInternalUser_Permission,'TRANSACTION')}  onClick={() => history.push(pathmenu.changePasswordInternalUser+'/'+id)}>{i18n.t('Ubah Password')}</MenuItem>
