...
import { addWarehouse_Permission } from '../../shared/permissionMenu';
...
export default function AddWarehouse(props) {
    reloadToHomeNotAuthorize(addWarehouse_Permission,'TRANSACTION');
    ...
    useEffect(() => {
        setLoading(true);
        dispatch(actions.getWarehouseData('/template',successHandlerTemplate, errorHandler));
    }, []);
    ...
    const executeSubmit = () => {
        ...
        if(flag){
            ...
            dispatch(actions.submitAddWarehouse('',obj,succesHandlerSubmit, errorHandler));
        }
    }
                ...
                formikProps => {
                    ...
                    return(
                        <form className="mb-6" onSubmit={handleSubmit}  name="FormAddWarehouse">
                            <ContentWrapper>
                            <ContentHeading history={history} link={pathmenu.addWarehouse} label={'Add Warehouse'} labeldefault={'Add Warehouse'} />
