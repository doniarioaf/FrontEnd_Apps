...
import { editWorkOrderType_Permission } from '../../../shared/permissionMenu';
import * as pathmenu           from '../../../shared/pathMenu';
import "react-widgets/dist/css/react-widgets.css";

export default function AddWorkOrderType(props) {
    reloadToHomeNotAuthorize(editWorkOrderType_Permission,'TRANSACTION');
    ...
    const executeSubmit = () => {
        ...
        if(flag){
            ...
            dispatch(actions.submitEditWorkOrderType('/'+id,obj,succesHandlerSubmit, errorHandler));
        }
    }
                ...
                formikProps => {
                    ...
                    return(
                        <form className="mb-6" onSubmit={handleSubmit}  name="FormAddBankAccount">
                            <ContentWrapper>
                            <ContentHeading history={history} link={pathmenu.editworkordertype+'/'+id} label={'Edit Work Order Type'} labeldefault={'Edit Work Order Type'} />
