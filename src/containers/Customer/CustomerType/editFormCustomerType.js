...
export default function AddFormCustomerType(props) {
    ...
    useEffect(() => {
        setLoading(true);
        dispatch(actions.getCustomerTypeData('/'+id,successHandlerDetail, errorHandler));
    }, []);
    ...
    const executeSubmit = () => {
        ...
        if(flag){
            ...
            dispatch(actions.submitEditCustomerType(id,obj,succesHandlerSubmit, errorHandler));
        }
    }
