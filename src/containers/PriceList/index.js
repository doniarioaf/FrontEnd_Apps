...
const MenuIndex = () => {
    ...
    useEffect(() => {
        setLoading(true);
        dispatch(actions.getPriceListData('',successHandler, errorHandler));
    }, []);
    ...
    return (
        <ContentWrapper>
            <ContentHeading history={history} removehistorylink={true} link={pathmenu.menuPriceList} label={'label_PRICE_LIST'} labeldefault={'Price List'} />
            <Container fluid>
            <Card>
            <CardBody>
