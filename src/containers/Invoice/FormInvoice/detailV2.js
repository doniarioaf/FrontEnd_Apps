            ...
            <CardBody>
                {
                    ...
                    (
                        <section>
                            ...
                            <span className="col-md-5">{i18n.t('No Invoice Jasa')}</span>
                            <strong className="col-md-7">
                                {value.nodocumentjasa?value.nodocumentjasa:''}
                            </strong>
                            </div>

                            <div className="row mt-3">
                            <span className="col-md-5">{i18n.t('Nilai Jasa')}</span>
                            <strong className="col-md-7">
                                {value.nilaijasa?formatRupiah(value.nilaijasa,2):''}
                            </strong>
                            </div>
                            ...
                            <strong className="col-md-7">
                            {value.nilaippn?formatRupiah(parseFloat(value.nilaippn)):''}
                            </strong>
                            </div>
                            ...
                            <strong className="col-md-7">
                            {value.totalinvoice?formatRupiah(parseFloat(value.totalinvoice)):''}
                            </strong>
                            </div>
                            ...
                            <strong className="col-md-7">
                            {value.nofakturpajak?value.nofakturpajak:''}
                            </strong>
                            </div>
