...
export const editWorkOrderStatus_Permission = ['EDIT_WORKORDER_STATUS'];
...
export const MenuRole = ['READ_ROLE'];
export const MenuProduct = ['READ_PRODUCT'];
export const MenuProductType = ['READ_PRODUCTTYPE'];
...
export const MenuCustomerType = ['READ_CUSTOMERTYPE'];
...
export const MenuReportInvoice = ['READ_REPORT_INVOICE'];
