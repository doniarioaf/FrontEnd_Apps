...
export const addParameterClient_Permission = ['CREATE_PARAMETERCLIENT'];
...
export const addMappingStock_Permission = ['READ_MAPPINGSTOCK','CREATE_MAPPINGSTOCK'];
...
export const addCargo_Permission = ['READ_CARGO','CREATE_CARGO'];
