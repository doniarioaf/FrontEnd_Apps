...
import { MenuReportRekapanBarangMasuk } from '../shared/permissionMenu';
import { formatdate , months} from '../shared/constantValue';
import * as pathmenu           from '../shared/pathMenu';
import "react-widgets/dist/css/react-widgets.css";

export default function ReportPembelian(props) {
    reloadToHomeNotAuthorize(MenuReportRekapanBarangMasuk,'READ');
    ...
    const successHandlerReport = (data) => {
        ...
        fileLink.download = 'ReportRekapBarangMasuk.xlsx';
        fileLink.click();
        fileLink.remove();
        setLoading(false);
                ...
                formikProps => {
                    ...
                    return(
                        <form className="mb-6" onSubmit={handleSubmit}  name="formReportStatusInvoice">
                            <ContentWrapper>
                            <ContentHeading history={history} removehistorylink={true} link={pathmenu.menuReportRekapBarangMasuk} label={'Laporan Rekapan Barang Masuk'} labeldefault={'Laporan Rekapan Barang Masuk'} />
