...
import { reloadToHomeNotAuthorize,isGetPermissions,numToMoneyWithComma } from '../../shared/globalFunc';
import { MenuParameterClient,addParameterClient_Permission } from '../../shared/permissionMenu';
...
const ParameterIndex = () => {
    ...
    useEffect(() => {
        setLoading(true);
        dispatch(actions.getParameterClientData('',successHandler, errorHandler));
    }, []);
    ...
    return (
        <ContentWrapper>
            ...
            <Grid
                ...
                permissionview={!isGetPermissions(MenuParameterClient,'READ')}
