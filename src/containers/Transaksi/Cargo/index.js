...
const DraftPurchaseReceiveIndex = () => {
    ...
    const [columns] = useState([
        ...
        { name: 'invoicenumber', title: i18n.t('Invoice Number') },
    ...
    useEffect(() => {
        ...
        obj.to = to.getTime();
        dispatch(actions.getCargoData({ url: '/list', type: 'POST', payload: obj }, successHandler, errorHandler));
    }, []);
    ...
    function onClickAdd() {
        history.push(pathmenu.addcargo);
    }
    function onClickView(id) {
        history.push(pathmenu.detailcargo + '/' + id);
    }
    ...
    return (
        <ContentWrapper>
            <ContentHeading history={history} removehistorylink={true} link={pathmenu.menucargo} label={'Cargo'} labeldefault={'Cargo'} />
            <Container fluid>
                <table>
                    <th>{'From'}</th>
                        ...
                        <Container fluid className="center-parent">
                            <div className="table-responsive">
                                <Grid
                                    ...
                                    permissionview={!isGetPermissions(MenuCargo, 'READ')}
