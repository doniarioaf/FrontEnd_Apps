...
export default function ViewFilePelunasanPiutang(props) {
    ...
    return (
        <ContentWrapper>
            <ContentHeading history={history} link={pathmenu.viewfilepelunasanpiutang+'/'+id} label={'View File'} labeldefault={'View File'} />
            <Container fluid>
                <Card>
                    <CardBody>
                        <Button
