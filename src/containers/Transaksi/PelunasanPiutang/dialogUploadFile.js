...
const DialogUploadFile = props => {
    ...
    function submitTrans(){
        if(isSelected && selectedFile !== undefined && selectedFile !== null){
            ...
            dispatch(actions.submitPelunasanPiutang({ url: '/file/'+props.idparam, payload: formData, type: 'ADD' }, props.handlesubmit, props.errorhandler));
        }   
    }
    ...
    return (
        <div>
            ...
            <input type="file" name="file" accept='.pdf, .jpg, .png, .jpeg' onChange={changeHandler} />
