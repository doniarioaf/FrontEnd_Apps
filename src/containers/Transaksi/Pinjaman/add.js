...
import { addPinjaman_Permission } from '../../shared/permissionMenu';
...
export default function AddDeposit(props) {
    reloadToHomeNotAuthorize(addPinjaman_Permission, 'TRANSACTION');
    ...
    const executeSubmit = (values) => {
        ...
        if (flag) {
            ...
            dispatch(actions.submitPinjaman({ url: '', payload: obj, type: 'ADD' }, succesHandlerSubmitData, errorHandler));
        }
    }
                ...
                formikProps => {
                    ...
                    return (
                        <form className="mb-6" onSubmit={handleSubmit} name="FormVendor">
                            <ContentWrapper>
                                <ContentHeading history={history} link={pathmenu.addpinjaman} label={'Add Pinjaman'} labeldefault={'Add Pinjaman'} />
