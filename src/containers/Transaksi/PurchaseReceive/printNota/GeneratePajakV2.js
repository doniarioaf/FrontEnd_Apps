...
const GeneratePurchaseReceivePajak = ({ valuedata }) => {
            ...
            <Fragment>
                {
                    IsReady ?
                        <View style={{ marginTop: '0px' }}>
                            ...
                            <View style={styles.tableRow}>
                            <View style={[styles.tableColWidth, { width:"100%", height: "100px" }]}>
                            ...
                            <View style={{ flexDirection: 'row',paddingTop:'78px' }}>
                                <View style={{ flexDirection: 'row-reverse',marginLeft: '59%', marginRight:'10px' }}>
                                
                                {/* <Text style={{ fontSize: 7 }}>{'Print By : '+(valuedata != null?valuedata.namaUser+' '+valuedata.currtime+', '+valuedata.currdate:'')}</Text> */}
                                <Text style={{ fontSize: 7 }}>{'Print By : '+(valuedata != null?valuedata.namaUser:'')}</Text>
                                </View>
...
export default GeneratePurchaseReceivePajak;