...
const lsitTambahDP = (value) =>{
    ...
    let transfer = value.nilaitransfer;//getTransfer({saldoDP:saldoDP,value:value});
   ...
   let viewSaldoDP = <View style={[{ width:"34%", height: "20px",paddingLeft:'4px' }]}>
    ...
    sisaDP = sisaDP - (nilaiNota - transfer);
...
const GeneratePurchaseReceiveSupplierHal2 = ({ valuedata }) => {
...
export default GeneratePurchaseReceiveSupplierHal2;