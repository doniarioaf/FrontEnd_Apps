...
const lsitTambahDP = (value) =>{
    ...
    let list = [];
    list.push(<Text style={[styles.tableCell, { width: 200, maxWidth: 200, marginTop: '1px', fontSize: fontSizeBig }]}>{"Saldo DP "}{desimal00(formatRupiah(new String(saldoDP).replaceAll('.',','),2)) }</Text>);
    if(deposits){
...
const setItems = (value) =>{
    ...
    if(items != undefined && items != null){
        ...
        for(let i=0; i < listfilteroutput.length; i++){
            ...
            rowItem.push(
                <View style={[styles.tableColWidth, { width:styles.width.harga, height: "25px" }]}>
                    <Text style={[styles.tableCell, { width: styles.width.widthharga, maxWidth: styles.width.widthharga, textAlign:'center', marginTop: '5px', fontSize: fontSizeBig }]}>{det.price?desimal00(formatRupiah(new String(det.price).replaceAll('.',','),2)):0}</Text>
                </View>
            );
            rowItem.push(
                <View style={[styles.tableColWidth, { width:styles.width.jumlah, height: "25px" }]}>
                    <Text style={[styles.tableCell, { width: styles.width.widthjumlah, maxWidth: styles.width.widthjumlah, textAlign:'center', marginTop: '5px', fontSize: fontSizeBig }]}>{det.subtotalprice?desimal00(formatRupiah(new String(det.subtotalprice).replaceAll('.',','),2)):0}</Text>
                </View>
            );
        ...
        rowItem.push(
            <View style={[styles.tableColWidth, { width:styles.width.jumlah, height: "25px" }]}>
                <Text style={[styles.tableCell, { width: styles.width.widthjumlah, maxWidth: styles.width.widthjumlah, textAlign:'center', marginTop: '5px', fontSize: fontSizeBig }]}>{desimal00(formatRupiah(new String(totalSubtotalPrice).replaceAll('.',','),2),{isShow000:false})}</Text>
            </View>
        );
        ...
        for(let i=0; i < listfilteroutputcharges.length; i++){
            ...
            rowItem.push(
                <View style={[styles.tableColWidth, { width:styles.width.namabarang, height: "25px" }]}>
                    <Text style={[styles.tableCell, { width: styles.width.widthnamabarang, maxWidth: styles.width.widthnamabarang, textAlign:'center', marginTop: '5px', fontSize: fontSizeBig }]}>{det.chargename}</Text>
                </View>
            );
            rowItem.push(
                <View style={[styles.tableColWidth, { width:styles.width.ukuran, height: "25px" }]}>
            ...
            rowItem.push(
                <View style={[styles.tableColWidth, { width:styles.width.jumlah, height: "25px" }]}>
                    <Text style={[styles.tableCell, { width: styles.width.widthjumlah, maxWidth: styles.width.widthjumlah, textAlign:'center', marginTop: '5px', fontSize: fontSizeBig }]}>{det.subtotalprice?addKurungBukaPadaValue(det.chargename,desimal00(formatRupiah(new String(det.subtotalprice).replaceAll('.',','),2))):0}</Text>
                </View>
            );
        ...
        for(let i=0; i < listfilteroutputinventori.length; i++){
            ...
            rowItem.push(
                <View style={[styles.tableColWidth, { width:styles.width.namabarang, height: "25px" }]}>
                    <Text style={[styles.tableCell, { width: styles.width.widthnamabarang, maxWidth: styles.width.widthnamabarang, textAlign:'center', marginTop: '5px', fontSize: fontSizeBig }]}>{det.inventoriname}</Text>
                </View>
            );
            rowItem.push(
                <View style={[styles.tableColWidth, { width:styles.width.ukuran, height: "25px" }]}>
        ...
        rowItem.push(
            <View style={[styles.tableColWidth, { width:styles.width.harga, height: "25px" }]}>
                <Text style={[styles.tableCell, { width: styles.width.widthharga, maxWidth: styles.width.widthharga, textAlign:'center', marginTop: '5px', fontSize: fontSizeBig }]}>{'Transfer'}</Text>
            </View>
        );
        rowItem.push(
            <View style={[styles.tableColWidth, { width:styles.width.jumlah, height: "25px" }]}>
                <Text style={[styles.tableCell, { width: styles.width.widthjumlah, maxWidth: styles.width.widthjumlah, textAlign:'center', marginTop: '5px', fontSize: fontSizeBig }]}>{desimal00(getTransfer(new String(value).replaceAll('.',','),2),{isShow000:false})}</Text>
            </View>
        );
            ...
            <Fragment>
                {
                    IsReady ?
                        <View style={{ marginTop: '0px' }}>
                            ...
                            <View style={styles.tableRow}>
                            <View style={[styles.tableColWidth, { width:"100%", height: "130px" }]}>
