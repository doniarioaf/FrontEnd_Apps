...
const DraftPackingListIndex = () => {
    ...
    useEffect(() => {
        ...
        obj.to = to.getTime();
        dispatch(actions.getPackingListData({ url: '/list', type: 'POST', payload: obj }, successHandler, errorHandler));
    }, []);
    ...
    return (
        <ContentWrapper>
            <ContentHeading history={history} removehistorylink={true} link={pathmenu.menupackinglist} label={'Packing List'} labeldefault={'Packing List'} />
            <Container fluid>
                <table>
                    <th>{'From'}</th>
...
export default DraftPackingListIndex;