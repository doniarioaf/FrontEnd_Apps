...
import { MenuStockAdjusment } from '../../../shared/permissionMenu';
import * as pathmenu from '../../../shared/pathMenu';
import "react-widgets/dist/css/react-widgets.css";

import { PDFViewer } from '@react-pdf/renderer';
import PdfDocumentStockMati from './PdfDocumentStockMati';
...
export default function PrintDraftPR(props) {
    ...
    const fileName = "FormUdangMati";

    useEffect(() => {
        setLoading(true);
        dispatch(actions.getStockAdjusmentData( {url:'/print/'+id},successHandler, errorHandler));
    }, [dispatch]);
    ...
    // const handleDownloadPDF = () => {
        ...
        dispatch(actions.getStockAdjusmentData({ url: '/catatdownload/' + id }, successHandlerDownload, errorHandler));
    }
    function successHandlerDownload(data, propsdata){
        dispatch(actions.getStockAdjusmentData( {url:'/print/'+id},successHandlerAfterDownload, errorHandler));
    }
                                        ...
                                        IsReady ?
                                            <div className="App">
                                                ...
                                                <PDFViewer style={{
                                                    ...
                                                    <PdfDocumentStockMati data={Value} />
