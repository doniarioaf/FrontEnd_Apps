...
const GenerateDocumentPdf = ({ valuedata }) => {
                    ...
                    IsReady ?
                        <View style={{ marginTop: '0px' }}>
                            ...
                            <View style={[styles.tableColWidthNoBorder, {  height: "50px",marginBottom:'80px',marginLeft:'200px' }]}>
                                <Text style={[{ fontFamily: 'roboto',width: styles.width.widthno, maxWidth: styles.width.widthno, marginTop: '5px', fontSize: 18,marginLeft:'60px' }]}>{"Cancel Packing List"}</Text>
