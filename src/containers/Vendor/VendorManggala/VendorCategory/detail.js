  ...
  function Detail(props) {
    ...
    const submitHandlerDelete = () => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                dispatch(actions.submitDeleteVendorCategory('/'+id,succesHandlerSubmit, errorHandler));
    ...
    const succesHandlerSubmit = (data) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                history.push(pathmenu.menuvendorcategory);
            }
        })
    }
    ...
    return (
        <ContentWrapper>
            <ContentHeading history={history} link={pathmenu.detailvendorcategory+'/'+id} label={'Detail Vendor Category'} labeldefault={'Detail Vendor Category'} />
            <Container fluid>
            <Card>
            <CardBody>
            <Button
